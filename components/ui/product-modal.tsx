          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
              ...
              <div className="p-8 flex flex-col justify-center space-y-6">
                ...
                <p className="text-lg font-inter text-neutral-600 dark:text-neutral-300 leading-relaxed">
                  {product.description}
                </p>
                
                <div className="space-y-4">
                  <h4 className="text-lg font-inter font-semibold text-neutral-900 dark:text-neutral-100">
                    
                  </h4>
                  <ul className="space-y-2 font-inter text-neutral-600 dark:text-neutral-300">
                  </ul>
                </div>

                {/* Action Buttons */}
                <div className="flex flex-col sm:flex-row gap-3 pt-4">
                  <button className="flex-1 font-inter bg-gradient-to-r from-neutral-900 to-neutral-700 hover:from-neutral-800 hover:to-neutral-600 dark:from-neutral-100 dark:to-neutral-300 dark:hover:from-neutral-200 dark:hover:to-neutral-400 text-white dark:text-black font-semibold px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105">
                    Contact for Details
                  </button>
